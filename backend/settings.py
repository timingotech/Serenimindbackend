...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to SereniMind Admin",

    # Copyright on the footer
    "copyright": "SereniMind Ltd",
    ...
    "icons": {
        ...
        "api.UserSettings": "fas fa-user-cog",
        "api.JournalEntry": "fas fa-book",
        "api.Community": "fas fa-users",
        "api.Message": "fas fa-comment",
        "api.Todo": "fas fa-tasks",
        "api.MoodAssessment": "fas fa-smile",
        "api.BotSettings": "fas fa-robot",
        "api.UserConversation": "fas fa-comments",
    },
